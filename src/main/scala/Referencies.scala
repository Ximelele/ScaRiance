class Referencies():
  ...
  def setPostfixDirectory(): Unit = {
    g1000prefix = "/app/references38/1000G_loci_hg38/1kg.phase3.v5a_GRCh38nounref_loci_"
    g1000alleleprefix = "/app/references38/1000G_loci_hg38/1kg.phase3.v5a_GRCh38nounref_allele_index_"
    impute_file = "/app/references38/impute_info.txt"
    problemLociFile = "/app/references38/probloci/probloci.txt.gz"
    beagleref = "/app/references38/beagle/CHROMNAME.1kg.phase3.v5a_GRCh38nounref.vcf.gz"
    beaglejar = "/app/references38/beagle/beagle.08Feb22.fa4.jar"
    beagleplink = "/app/references38/beagle/plink.CHROMNAME.GRCh38.map"
